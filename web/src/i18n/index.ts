  ...
  en: {
    translation: {
      ...
      usage_stats: {
        ...
        openrouter_price: 'OpenRouter',
        openrouter_reference: 'OR Ref',
        custom_price: 'Custom',
        reset_price: 'Reset to OR',
        sync_openrouter_prices: 'Sync OpenRouter Prices',
        syncing_openrouter: 'Syncing...',
        ...
        webhook_url_placeholder: 'https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=...',
        test_webhook: 'Send Test',
        test_webhook_success: 'Test message sent successfully',
        test_webhook_failed: 'Test message failed',
        rule_name: 'Rule Name',
        rule_type: 'Rule Type',
        token_threshold_rule: 'Token Usage Threshold',
        connection_failure_rule: 'Connection Failure Alert',
        threshold: 'Threshold',
        tokens_unit: 'Tokens',
        window_minutes: 'Time Window (min)',
        cooldown_minutes: 'Cooldown (min)',
        last_notified: 'Last Notified',
        never_notified: 'Never',
        channel_empty: 'No notification channels yet',
        rule_empty: 'No alert rules yet',
        select_channel: 'Select Channel',
        enabled: 'Enabled',
        disabled: 'Disabled',
        rule_trigger_summary_token: 'Alert when {{type}} exceeds {{threshold}} tokens in {{window}} min',
        rule_trigger_summary_failure: 'Alert on failed requests in {{window}} min',
      }
    }
  },
  zh: {
    translation: {
      ...
      usage_stats: {
        ...
        openrouter_available: 'OpenRouter',
        openrouter_price: 'OpenRouter',
        openrouter_reference: 'OR 参考',
        custom_price: '自定义',
        reset_price: '恢复为 OpenRouter',
        sync_openrouter_prices: '同步 OpenRouter 价格',
        syncing_openrouter: '同步中...',
        ...
        webhook_url_placeholder: 'https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=...',
        test_webhook: '发送测试',
        test_webhook_success: '测试消息发送成功',
        test_webhook_failed: '测试消息发送失败',
        rule_name: '规则名称',
        rule_type: '规则类型',
        token_threshold_rule: 'Token 用量阈值',
        connection_failure_rule: '连接失败告警',
        threshold: '阈值',
        tokens_unit: 'Tokens',
        ...
        last_notified: '上次通知',
        never_notified: '从未通知',
        channel_empty: '暂无通知渠道，请先添加',
        rule_empty: '暂无告警规则',
        select_channel: '选择渠道',
        enabled: '启用',
        disabled: '禁用',
        rule_trigger_summary_token: '当过去 {{window}} 分钟内 Token 用量超过 {{threshold}} 时告警',
        rule_trigger_summary_failure: '当过去 {{window}} 分钟内出现失败请求时告警',
      }
    }
  }
};
