...
class ModelPriceSetting(Base):
    ...
    # DeepInfra reference prices (primary source)
    deepinfra_model_id = Column(String, nullable=True)
    deepinfra_prompt_price_per_1m = Column(Float, nullable=True)
    deepinfra_completion_price_per_1m = Column(Float, nullable=True)
    deepinfra_cache_price_per_1m = Column(Float, nullable=True)
    # OpenRouter reference prices (fallback source)
